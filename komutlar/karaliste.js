...
exports.run = async (client, message, args) => {
 if(message.author.id !== "990205109411651604") if(message.author.id !== "990205109411651604") return message.channel.send("hoop bilader sahip komutu bu");
  let user = args[0]
  ...
  .setFooter("Hype")
  .setTimestamp()
  .setDescription(` <@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık Hype'ın komutlarını kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`)
